...
<div class="wrap">
  ...
  <p class="muted">Four statuses, and the difference between them is the point:
    ...
    <span class="badge badge-amber">&#9888; not gradeable</span> the record predates the cadence field and declared no deadline, so there is nothing to grade &mdash; <strong>cannot determine, not pass</strong> (<code>cadence_gradeable:false</code>). Nothing is backfilled to close that gap.</p>${auditOn ? `
  <div class="panel">${auditStatus.renderAuditSummary(audit, { noun: "namespaces" })}</div>` : ""}
